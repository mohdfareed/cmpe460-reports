...
# time_difference = np.array(
#     [0, 0, -0.04, -0.036, -0.04, -0.03, -0.026, -0.018, -0.012, -0.009]
# )
...
time_difference = np.array(
    [0.57, 0.25, 0.12, 0.05, -0.012, -0.018, -0.02, -0.019, -0.016, -0.012]
)
...
phase = (time_difference * frequency) * 360  # phase in degrees
...
ax2.set_title("$$\\textrm{Phase (Degrees) vs Frequency (Hz)}$$")
ax2.set_xlabel("$$\\textrm{Frequency (Hz)}$$")
ax2.set_ylabel("$$\\textrm{Phase (Degrees)}$$")
